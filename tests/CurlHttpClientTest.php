...
class CurlHttpClientTest extends TestCase
{
    ...
    {
        $client = new CurlHttpClient(new Response(), new Uri());
    ...
    {
        $client = $this->getMock(CurlHttpClient::class, ['request'], [new Response(), new Uri()]);
        ...
        $client->expects(static::exactly(2))->method('request')->willReturnCallback(
            function ($options, &$raw, &$info) {
                ...
                if (1 == $it) {
                    ...
                    $info = ['redirect_count' => 0, 'header_size' => 46];
                } else {
